        ...
        <form role="form" method="post">
            <div class="box-body">
                ...
                <div class="form-group" >
                    ...
                    <input type="text" name="keyword" class="form-control" id="artice_keyword" placeholder="文章关键字">
                </div>

                <div>
                    <label for="describe">文章描述</label>
                    <textarea class="form-control" name="describe" rows="3" placeholder="文章描述 ..."></textarea>
                </div>
                <div>
